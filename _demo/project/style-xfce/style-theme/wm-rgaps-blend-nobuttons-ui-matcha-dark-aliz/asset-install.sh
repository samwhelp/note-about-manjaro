...
theme_asset_install () {
	...
	theme_asset_install_wm_rgaps_blend_nobuttons
...
theme_asset_install_wm_rgaps_blend_nobuttons () {
	...
	theme_asset_install_wm_rgaps_blend_nobuttons_clone

	echo "$(pacman -Ql xfce4-settings | grep appearance-install-theme | cut -d ' ' -f 2) 'asset/Drzaln_Nema/RGapsBlendNoButtons'"
	#/usr/lib/xfce4/settings/appearance-install-theme 'asset/Drzaln_Nema/RGapsBlendNoButtons'
	$(pacman -Ql xfce4-settings | grep appearance-install-theme | cut -d ' ' -f 2) 'asset/Drzaln_Nema/RGapsBlendNoButtons'
