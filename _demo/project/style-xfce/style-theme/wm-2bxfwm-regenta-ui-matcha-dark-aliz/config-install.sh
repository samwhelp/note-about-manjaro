...
theme_config_install_wm_theme () {
	...
	xfconf-query -c 'xfwm4' -p '/general/theme' -s '2bxfwm-Regenta'
	echo "xfconf-query -c 'xfwm4' -p '/general/theme' -s '2bxfwm-Regenta'"
	...
	## <property name="theme" type="string" value="2bxfwm-Regenta"/>
	##
