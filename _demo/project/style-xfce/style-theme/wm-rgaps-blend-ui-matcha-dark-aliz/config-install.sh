...
theme_config_install_wm_theme () {
	...
	xfconf-query -c 'xfwm4' -p '/general/theme' -s 'RGapsBlend'
	echo "xfconf-query -c 'xfwm4' -p '/general/theme' -s 'RGapsBlend'"
	...
	## <property name="theme" type="string" value="RGapsBlend"/>
	##
