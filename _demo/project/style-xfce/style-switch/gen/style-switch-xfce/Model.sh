...
<?php include_once(__DIR__ . '/Section/Model/wm_rgaps_blend_nobuttons_ui_obsidian_2_gray/Core.sh'); ?>
<?php include_once(__DIR__ . '/Section/Model/wm_rgaps_blend_nobuttons_ui_shades_of_gray/Core.sh'); ?>
<?php include_once(__DIR__ . '/Section/Model/wm_rgaps_blend_nobuttons_ui_matcha_dark_aliz/Core.sh'); ?>
<?php include_once(__DIR__ . '/Section/Model/wm_rgaps_blend_nobuttons_ui_nordic/Core.sh'); ?>
<?php include_once(__DIR__ . '/Section/Model/wm_rgaps_blend_nobuttons_ui_dracula/Core.sh'); ?>
