...
# * https://github.com/samwhelp/note-about-manjaro/blob/gh-pages/_demo/project/vimrc-profile/nvimrc-ctrl/remote-install.sh
# * https://github.com/samwhelp/note-about-manjaro/blob/gh-pages/_demo/project/vimrc-profile/nvimrc-ctrl/nvimrc-ctrl
# * https://raw.githubusercontent.com/samwhelp/note-about-manjaro/gh-pages/_demo/project/vimrc-profile/nvimrc-ctrl/nvimrc-ctrl
...
## $ export DEBUG_NVIMRC_CTRL_INSTALL=true
is_debug () {
	if [ "$DEBUG_NVIMRC_CTRL_INSTALL" = "true" ]; then
		return 0
	fi
...
base_var_init () {
	...
	if [ "none${THE_CMD_FILE_NAME}" = 'none' ]; then
		THE_CMD_FILE_NAME="nvimrc-ctrl-install"
	fi
	...
	## Target
	## https://github.com/samwhelp/note-about-manjaro/blob/gh-pages/_demo/project/vimrc-profile/nvimrc-ctrl/nvimrc-ctrl
	THE_TARGET_DOWNLOAD_URL='https://raw.githubusercontent.com/samwhelp/note-about-manjaro/gh-pages/_demo/project/vimrc-profile/nvimrc-ctrl/nvimrc-ctrl'


	THE_TARGET_FILE_NAME="nvimrc-ctrl"
