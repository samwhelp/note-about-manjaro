...
# * https://github.com/samwhelp/note-about-manjaro/blob/gh-pages/_demo/project/style-grub/style-ctrl/remote-install.sh
# * https://github.com/samwhelp/note-about-manjaro/blob/gh-pages/_demo/project/style-grub/style-ctrl/style-ctrl-grub
# * https://raw.githubusercontent.com/samwhelp/note-about-manjaro/gh-pages/_demo/project/style-grub/style-ctrl/style-ctrl-grub
...
base_var_init () {
	...
	if [ "none${THE_CMD_FILE_NAME}" = 'none' ]; then
		THE_CMD_FILE_NAME="style-ctrl-grub-install"
	fi
	...
	## Target
	## https://github.com/samwhelp/note-about-manjaro/blob/gh-pages/_demo/project/style-grub/style-ctrl/style-ctrl-grub
	THE_TARGET_DOWNLOAD_URL='https://raw.githubusercontent.com/samwhelp/note-about-manjaro/gh-pages/_demo/project/style-grub/style-ctrl/style-ctrl-grub'


	THE_TARGET_FILE_NAME="style-ctrl-grub"
